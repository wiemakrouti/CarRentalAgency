  ...
  return (
    ...
    >
      <Link
        to="/profile"
        className={cn(
          'relative flex h-16 shrink-0 items-center gap-2 border-b border-sidebar-border px-4 transition-colors hover:bg-sidebar-accent/60',
      ...
      <div className="relative border-t border-sidebar-border p-3">
        {!collapsed && (
          <Link
            ...
            className="mb-2 flex items-center gap-2.5 rounded-xl px-2 py-2 transition-colors hover:bg-sidebar-accent/60"
          >
