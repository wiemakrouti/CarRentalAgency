...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border/60 transition-colors last:border-0 hover:bg-primary-50/60 data-[state=selected]:bg-primary-50 dark:hover:bg-primary/10 dark:data-[state=selected]:bg-primary/15",
      className
    )}
    {...props}
  />
